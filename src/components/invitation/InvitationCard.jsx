                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex flex-col md:flex-row items-center md:items-start gap-3 rounded-lg border border-[rgba(46,91,168,0.14)] bg-white/60 p-4">
                                ...
                                <div>
                                    ...
                                    <a className="flex flex-row items-center justify-center p-2 bg-[#e8f4f8] rounded-lg hover:bg-[#d1e8f0] transition font-montserrat font-bold text-xs md:text-md text-blue-600 gap-4" target="_blank" href="https://maps.app.goo.gl/tETu8aGPuX7sdw3i8"><img className="size-8" src="svg/Google-Maps.svg" alt="" />Visualizar Localização</a>
                                </div>
                            </div>
                        </div>
